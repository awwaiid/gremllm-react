...
> Build-time LLM-generated React components

Transform natural language prompts into React components at build time. Write `<Gremllm prompt="A calculator" />` and get a fully functional calculator component generated by AI.

## Features

- 🏗️ **Build-time generation** - Components generated during build, zero runtime overhead
- 🎯 **Simple API** - Just write `<Gremllm prompt="..." />`
- ⚡ **Caching** - Generated components are cached to avoid regenerating on every build
- 🔧 **TypeScript support** - Full TypeScript support with proper types
- 🎨 **Production ready** - No eval(), no runtime code generation
